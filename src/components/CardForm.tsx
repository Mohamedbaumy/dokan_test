...
const CardForm = forwardRef<CardFormRef, CardFormProps>(
  ({ onFormChange, onValidationChange }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      ...
      validateAndShowErrors: () => {
        ...
        const cvcValidation = validateCVC(formData.cvc);
    ...
    useEffect(() => {
      ...
      const isFormValid = allFieldsValid && allFieldsFilled;
